    ...
    if(isset($_POST["btnSubmit"])){
        ...
        if($row =mysqli_fetch_array($ret)){
          ...
          if($new_password == $con_password){
           ...
           $up = "UPDATE student SET password = '$new_password' WHERE index_no = '$username'";   
                    ...
                    <div class="col-lg-8">
                        ...
                        <form action="#" method="post">
                            ...
                            <div class="form-outline mb-4">
                                <input type="text" id="form3Example3" class="form-control" name="txtUsername" placeholder="Enter your index No." required>
                            </div>
                            ...
                            <div >
                                Back to <a href="http://localhost/FInal%20Project/login/student/" style = "text-decoration:none;">Login</a>
                            </div>
                        </form>
